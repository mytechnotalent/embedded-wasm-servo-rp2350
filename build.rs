...
//!
//! # Build Script for embedded-wasm-servo-rp2350 Firmware
//!
//! Sets up the RP2350 linker script, compiles the Wasm servo application,
...
/// Compiles the Wasm servo application for the `wasm32-unknown-unknown` target.
///
/// # Panics
///
...
/// # Arguments
///
/// * `out` - Output directory path where `servo.cwasm` will be placed.
///
/// # Panics
///
